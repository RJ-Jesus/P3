...
public class Menu implements java.io.Serializable {
    ...
    private LinkedList<Meal>[] meals = (LinkedList<Meal>[]) new LinkedList<?>[DayOfWeek.size];
    ...
    public static Menu load(final File f) throws IOException, ClassNotFoundException {
        ...
        Menu rtn = (Menu) ois.readObject();
        ois.close();
        return rtn;
    }

    public Object[][] getContents() {
        Object[][] arr = new Object[meals.length][];
    ...
    public Meal removeMeal(final int idx, final Date.DayOfWeek d) {
        return meals[d.ordinal()].remove(idx);
    }

    public int indexOf(final Meal m, final Date.DayOfWeek d) {
